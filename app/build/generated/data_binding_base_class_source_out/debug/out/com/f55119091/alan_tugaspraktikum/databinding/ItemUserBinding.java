...
public final class ItemUserBinding implements ViewBinding {
  ...
  private ItemUserBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView userAvatar,
      @NonNull TextView userType, @NonNull TextView userUsername) {
  ...
  public static ItemUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserBinding((ConstraintLayout) rootView, userAvatar, userType, userUsername);
    }
